...
提交问题编辑：Route::post('ask/question/{quesiton_id}/edit', 'AskController@postQuestionEdit');
---------------------
...
提交答案编辑：Route::post('ask/answer/<answer_id>/edit', 'AskController@postAnswerEdit');
```
